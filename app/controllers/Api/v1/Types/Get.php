...
namespace DS\Controller\Api\v1\Types;
...
class Get extends ActionHandler implements MethodInterface
{
     ...
     * Process Get Method
     *
     * @api               {get} /api/v1/types Request all content types
     * @apiVersion        1.0.0
     * @apiName           Topics
     * @apiGroup          Public
     *
     ...
     * @apiSuccess {string} data.id Id of type
     * @apiSuccess {string} data.title Title of type
     *
    ...
    {
        return new Records(Types::getAll());
    }
