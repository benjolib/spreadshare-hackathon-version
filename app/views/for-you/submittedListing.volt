<div class="u-flex u-sm-flexCol u-md-flexRow">
    <div class="collaboration-info u-flex">
        <img class="collaboration-info__image" src="{{ listing.submitterImage }}" />
        <div>
            <a class="collaboration-info__user-name" href="/profile/{{ listing.submitterHandle }}">{{ listing.submitterName }}</a>
...
<div class="table-scroll table-scroll--collaborations">
    <table class="re-table re-table--list">
        ...
        <tr data-id="1" class="list-row-tr">
            ...
            <td>
                <div class="re-table__list-image" style="background: #f5f5f5 url({{ listing.image }}) center / cover;"></div>
            </td>
            {% for column in columns %}
