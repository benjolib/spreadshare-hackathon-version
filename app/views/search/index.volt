...
{# page title #}
{% block title %}SpreadShare - Search{% endblock %}
    ...
    search.addWidget({
        init: function (params) {
            ...
            function scrollhandler() {
                var isAtBottomOfPage = $(window).scrollTop() + $(window).height() > $(document).height() - 500;
            ...
            if (params.results.nbHits > 0) {
                html = hits.map(function (hit) {
                    return `
                            ...
                            <td>
                                <a class="" href="/stream/${ hit.objectID }">
                                    <h3>
                                        ...
                                        <span class="list-card__subscriberCount">${ Math.floor(Math.random() * (25 - 1 + 1)) + 1 }</span>
                                    </h3>
                                    <p>${ hit.description }</p>
                                    <p>${ hit.tagline }</p>
                                </a>
                        ...
                        <tr class="re-table-space">
                        </tr>
                    `
                });
            } else {
                html = [`
                    <div class="re-page"></div>
                    <div class="info-box">
                        <div class="info">
