...
{% block title %}SpreadShare - Create{% endblock %}
    ...
    <div class="re-page re-page--create-list">
        <form id="createListFrom" method="post" action="" enctype="multipart/form-data">
            {% if tableId is defined %}
                {{ hidden_field('tableId', 'value':tableId) }}
            {% endif %}
            {% if tempImage is defined %}
                {% set imageStyle='background: #f5f5f5 url('~tempImage~') center / cover;' %}
                {# TODO I don't think the hidden field is needed anymore #}
                {{ hidden_field('tempImage','value':tempImage) }}
            {% else %}
                {% set imageStyle='' %}
            {% endif %}

            <div class="re-image re-image--create-list" style="{{ imageStyle }}">
...
<!--
            <div class="create-list-has-thumbnails">
                ...
                <p>Do your posts have thumbnails?</p>
...
-->
            ...
            <div class="create-list-add-curators">
                <div class="ui fluid multiple search selection dropdown curators">
            ...
            <div class="create-create-list-tabs">
                <div class="create-create-list-tabs__inner">
                    ...
                    <div class="create-list-tab-buttons u-flex extra-small-gutter">
                        <a href="#" class="re-button re-button--grey extra-small-margin create-list-tab-button create-list-tab-button-copy">
                            <img src="/assets/icons/copy-and-paste.svg" />
                            Copy & Paste
                        </a>
                        <a href="#" class="re-button re-button--grey extra-small-margin create-list-tab-button create-list-tab-button-import">
                            <img src="/assets/icons/upload-via-csv.svg" />
                            Upload via CSV
                        </a>
                    ...
                    <div class="create-list-tab-content create-list-tab-content-import" style="display: none;">
                        <div class="u-flex small-gutter">
                            ...
                            <a href="#" class="re-button re-button--full-width small-margin" id="file-upload-button">
                                <img class="re-button__icon" src="/assets/images/create-list-import-browse-file.svg" />
                                Browse File
                            </a>
...
$('.short-description-textarea').keyup(function (e) {
    // resize description text area to have no scroll
