...
{% block content %}
  ...
  <div class="__page__wrapper">
    ...
    <div id="roadmap">
    <h3>Roadmap</h3>
    <p>We’re focussing on iterating our product based on the learnings from our most recent release. We’ll be starting by letting selected users access our platform. Together with them we’ll explore the way they use the product and define a roadmap to iterate it. There’s more features to come, bugs to fix, new ideas to design and content to be added. 🚨 Interested to have a look on our code and explore ways to collaborate? Just send us a mail to <a href="mailto:hi@spreadshare.co">hi@spreadshare.co</a></p>
    <br>
    <p>What we’re definitely going to do is to offer the options to withdraw or deposit tokens on SpreadShare – as well as the possibility to trade our tokens on exchanges – are key features on our product roadmap and will be introduced at a later stage. There will also be a token sale soon.</p>
    <p>And here’s a glimpse into our Roadmap</p>
    <ul>
