...
abstract class AbstractTableStats extends \DS\Model\Base
{
     ...
     * @Column(type="integer", length=11, nullable=true)
     */
    protected $unconfirmedChangesCount;
    ...
    /**
     * Method to set the value of field unconfirmedChangesCount
     *
     * @param integer $unconfirmedChangesCount
     * @return $this
     */
    public function setUnconfirmedChangesCount($unconfirmedChangesCount)
    {
        $this->unconfirmedChangesCount = $unconfirmedChangesCount;
    ...
    /**
     * Returns the value of field unconfirmedChangesCount
     *
     * @return integer
     */
    public function getUnconfirmedChangesCount()
    {
        return $this->unconfirmedChangesCount;
    }
