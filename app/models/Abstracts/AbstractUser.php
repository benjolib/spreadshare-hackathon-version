...
abstract class AbstractUser extends \DS\Model\Base
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'DS\Model\Abstracts\Rows', 'lastEditedById', ['alias' => 'Rows']);
        $this->hasMany('id', 'DS\Model\Abstracts\Rows', 'userId', ['alias' => 'Rows']);
        $this->hasMany('id', 'DS\Model\Abstracts\Tablecomments', 'userId', ['alias' => 'Tablecomments']);
        $this->hasMany('id', 'DS\Model\Abstracts\Tabletags', 'userId', ['alias' => 'Tabletags']);
        $this->hasMany('id', 'DS\Model\Abstracts\Tablevotes', 'userId', ['alias' => 'Tablevotes']);
        $this->hasMany('id', 'DS\Model\Abstracts\Tables', 'userId', ['alias' => 'Tables']);
